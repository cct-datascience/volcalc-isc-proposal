...
- Assistant Professor Laura Meredith developed the original idea for the `volcalc` R package along with Kristina Riemer and is supportive of continued development by our team.
...
Tamás Stirling, maintainer of the `webchem` R package (part of rOpenSci), was consulted and confirmed that `volcalc` is not replicating the efforts of any similar R packages that we are aware of. 
